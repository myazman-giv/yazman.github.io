...
<body >
    <h3 style="text-align: center;">Form Tambah Data</h3><hr>
    <form action="" method="post" style="align-content: center;">
        <ul align="center">
                ...
                <input type="textarea" name="deskripsi" id="deskripsi" required><br><br>
                <label for="umur">Umur : </label><br>
                <input type="text" name="umur" id="umur" required><br><br>
                <label for="bobot">Bobot : </label><br>
                <input type="text" name="bobot" id="bobot" required><br><br>
